...
{
    // KV
    protected const URI_PUT = 'kv/put';
    protected const URI_RANGE = 'kv/range';
    protected const URI_DELETE_RANGE = 'kv/deleterange';
    protected const URI_TXN = 'kv/txn';
    protected const URI_COMPACTION = 'kv/compaction';

    // Lease
    protected const URI_GRANT = 'lease/grant';
    protected const URI_REVOKE = 'kv/lease/revoke';
    protected const URI_KEEPALIVE = 'lease/keepalive';
    protected const URI_TIMETOLIVE = 'kv/lease/timetolive';

    // Role
    protected const URI_AUTH_ROLE_ADD = 'auth/role/add';
    protected const URI_AUTH_ROLE_GET = 'auth/role/get';
    protected const URI_AUTH_ROLE_DELETE = 'auth/role/delete';
    protected const URI_AUTH_ROLE_LIST = 'auth/role/list';

    // Authenticate
    protected const URI_AUTH_ENABLE = 'auth/enable';
    protected const URI_AUTH_DISABLE = 'auth/disable';
    protected const URI_AUTH_AUTHENTICATE = 'auth/authenticate';

    // User
    protected const URI_AUTH_USER_ADD = 'auth/user/add';
    protected const URI_AUTH_USER_GET = 'auth/user/get';
    protected const URI_AUTH_USER_DELETE = 'auth/user/delete';
    protected const URI_AUTH_USER_CHANGE_PASSWORD = 'auth/user/changepw';
    protected const URI_AUTH_USER_LIST = 'auth/user/list';

    protected const URI_AUTH_ROLE_GRANT = 'auth/role/grant';
    protected const URI_AUTH_ROLE_REVOKE = 'auth/role/revoke';

    protected const URI_AUTH_USER_GRANT = 'auth/user/grant';
    protected const URI_AUTH_USER_REVOKE = 'auth/user/revoke';

    protected const PERMISSION_READ = 0;
    protected const PERMISSION_WRITE = 1;
    protected const PERMISSION_READWRITE = 2;

    protected const DEFAULT_HTTP_TIMEOUT = 30;
     ...
     * @return Client
     */
    public function setHttpOptions(array $options): Client
    {
     ...
     * @return Client
     */
    public function setPretty($enabled): Client
    {
        $this->pretty = $enabled;
        return $this;
    }
     ...
     * @return $this
     */
    public function clearToken(): Client
    {
        $this->token = null;
        return $this;
    }
